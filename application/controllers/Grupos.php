...
class Grupos extends CI_Controller
{
    ...
    public function report_todos_los_estudiantes_por_grupo(){//
        ...
        $this->table->set_heading('Código','Estudiantes');//

        $this->load->model('Grupo_model');
        $grupo_estudiantes = $this->Grupo_model->getAllGrupoEstudiantes();//aqui

        foreach ($grupo_estudiantes as $grupo_estudiante):
            $this->table->add_row($grupo_estudiante->idestudiante, $grupo_estudiante->AlumnoGrupo);
        endforeach;
